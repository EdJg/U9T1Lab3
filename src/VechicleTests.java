...
//    Vehicle test = new Vehicle("MC56WQ", 10.75, 5);
//    System.out.println(test.calculateTollPrice());
//
//
//
...
//    Car test2 = new Car("KXN73F", 8.50, 2, true);
//    System.out.println(test2.calculateTollPrice());
//
//
//
...
//    //    Print out the calculated toll price
//    Truck test3 = new Truck("3K9JMX", 24.75, 4, 6, true);
//    System.out.println(test3.calculateTollPrice());
//
//
//
...
//    Taxi test4 = new Taxi("8KM23Z", 9.25, 3, true, 5);
//    test4.printTaxi();
//
//    System.out.println(test4.getLicensePlate());
//    System.out.println(test4.getTollFee());
//    System.out.println(test4.getPassengers());
//    System.out.println(test4.calculateTollPrice());
//
//    System.out.println(test4.isElectric());
//    System.out.println(test4.isDiscountApplied());
//    test4.printCar();
//
//    System.out.println(test4 instanceof Taxi);
//    System.out.println(test4 instanceof Car);
//    System.out.println(test4 instanceof Vehicle);
